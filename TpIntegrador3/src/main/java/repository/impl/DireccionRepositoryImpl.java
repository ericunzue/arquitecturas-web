...
public class DireccionRepositoryImpl implements DireccionRepository {
	...
	EntityManager em;
	private static DireccionRepository soleInstance =null;

	public static DireccionRepository getInstance(EntityManager em) {
		if(soleInstance==null) {
			return (new DireccionRepositoryImpl(em));
		}
		return soleInstance;
	}

	private DireccionRepositoryImpl(EntityManager em) {
		super();
		this.em = em;
	}
